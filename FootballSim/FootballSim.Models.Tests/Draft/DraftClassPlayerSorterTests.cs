...
namespace FootballSim.Models.Tests.Draft
{
    ...
    public class DraftClassPlayerSorterTests : BaseTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            _p1.Ratings.Add(RatingType.ThrowingPower, new Rating(60));
            _p2 = new Player
                      {
                          LastName = "Doe",
                          FirstName = "Jane",
            ...
            _p2.Ratings.Add(RatingType.RunBlocking, new Rating(90));
            _p3 = new Player
                      {
                          LastName = "Doe",
                          FirstName = "John",
            ...
            _p3.Ratings.Add(RatingType.ThrowingPower, new Rating(70));
        ...
        {
            _p3.Ratings[RatingType.ThrowingPower] = new Rating(50);
            var result = _sut.Sort(_players);
